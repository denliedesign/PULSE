...
@section('content')
    ...
    <x-photo tag="banner-age5-6" class="img-fluid" style="width: 100%; height: 500px; object-fit: cover; object-position: center;"/>

    {{--    <div class="banner-wrap-lg d-none d-md-block">--}}
{{--        <div class="banner-lg within-5-6"></div>--}}
{{--    </div>--}}
{{--    <img src="/images/24-classes-2.JPG" alt="girl doing headstand" class="img-fluid d-block d-md-none">--}}
